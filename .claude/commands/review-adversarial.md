...
Spawne o agente `reviewer` duas vezes numa única mensagem, cada um com uma lente distinta, entregando a cada um **apenas** o comando de diff e o requisito original — nunca o relatório de quem escreveu o código.
