...
|---|---|
| Freio da revisão adversarial: reportar só o que afeta correção ou o requisito declarado | na skill `adversarial-review`, seção "Freio de escopo: o que não entra no laudo" |
