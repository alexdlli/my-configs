...
| `"$MAESTRI_CLI"`, protocolo das "Team Context" / "Todo for Alex", verbos de recruta, o floor como primitiva de isolamento, o portal como instrumento de prova | `maestri-orchestration` — é o que sobrou de genuinamente específico |
